...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        nargs='?',
        default='nvidia_relu_dropout',
        help='Name of the CNN model to train'
    )
    parser.add_argument(
        '--init',
        dest="model_init",
    ...
    parser.add_argument(
        ...
        help='Total number of samples to generate per epoch.'
    )
    parser.add_argument(
        '--batch_size',
        type=int,
    ...
    parser.add_argument(
        ...
        help='Path to training example. This folder should contain IMG and driving_log.csv file.'
    )
    parser.add_argument(
        'model_dir',
        type=str,
        ...
        help='This is where the trained model will be saved.'
    )
